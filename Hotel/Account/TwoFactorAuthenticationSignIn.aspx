<%@ Page Title="Autenticación de dos factores" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="Hotel.TwoFactorAuthenticationSignIn" %>
